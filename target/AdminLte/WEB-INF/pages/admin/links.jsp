...
<title>JavaByKiran | Useful Links</title>
			...
			<section class="sidebar">
				...
				<div class="user-panel">
					<div class="pull-left image">
						<img src="<spring:url value="/resources/dist/img/user2-160x160.jpg"/>" class="img-circle"
							alt="User Image">
					</div>
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">* Internet Required</h3>
							...
							<div class="box-body table-responsive no-padding">
								<table class="table table-hover">
									...
									<tr>
										<td>01</td>
										<td>Schedule</td>
										<td><a href="https://www.javabykiran.com/news"
											target="_blank"><span class="label label-success">Go
													!</span></a></td>
									</tr>
									<tr>
										<td>02</td>
										...
										<td><a
											href="https://www.javabykiran.com/java-by-kiran-videos"
											target="_blank"><span class="label label-success">Go
													!</span></a></td>
									</tr>
									<tr>
										...
										<td><a
											href="https://www.javabykiran.com/selenium-testing-interview-question-answer"
											target="_blank"><span class="label label-success">Go
													!</span></a></td>
									</tr>
									<tr>
										...
										<td><a
											href="https://www.javabykiran.com/core-java-interview-question-answer"
											target="_blank"><span class="label label-success">Go
													!</span></a></td>
									</tr>
									<tr>
										<td>05</td>
										<td>Courses</td>
										<td><a href="https://www.javabykiran.com/courses"
											target="_blank"><span class="label label-success">Go
													!</span></a></td>
									</tr>
									<tr>
										<td>06</td>
										<td>Placement</td>
										<td><a href="https://www.javabykiran.com/placement"
											target="_blank"><span class="label label-success">Go
													!</span></a></td>
									</tr>
								</table>
