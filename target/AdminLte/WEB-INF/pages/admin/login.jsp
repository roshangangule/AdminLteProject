...
<!-- iCheck -->
<link rel="stylesheet"
	href='<spring:url value="/resources/plugins/iCheck/square/blue.css"/>'>
...
<body class="hold-transition login-page">
	...
	<div class="login-box">
	<center>
			<img src="<spring:url value="/resources/dist/img/jbk.png"/>" height="150px">
	</center>	
		...
		<div class="login-box-body">
			...
			<form id="form" action="<spring:url value="/login" />" method="post">
...
glyphicon-envelope form-control-feedback"></span>
			...
			<br> <a href="<spring:url value="/registerpage"/>"> Add New Employee</a>
		</div>
		<!-- /.login-box-body -->
	</div>
	<!-- /.login-box -->
...
value="resources/plugins/iCheck/icheck.min.js"/>"></script>
	<script>
